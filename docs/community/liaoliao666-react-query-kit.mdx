...
> 文本内容来自[React Query Kit: README-CN.md](https://raw.githubusercontent.com/liaoliao666/react-query-kit/main/README-zh_CN.md)
...
- [Examples](#examples)
  ...
  - [createInfiniteQuery](#createinfinitequery)
    - [Usage](#usage-1)
    - [额外的 API 文档](#额外的api文档-1)
  - [createMutation](#createmutation)
    - [Usage](#usage-2)
    - [额外的 API 文档](#额外的api文档-2)
  - [Issues](#issues)
    - [🐛 Bugs](#-bugs)
